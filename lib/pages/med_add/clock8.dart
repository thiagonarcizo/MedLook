...
class Clock8 extends StatefulWidget {
  Clock8({Key? key}) : super(key: key);

  @override
  State<Clock8> createState() => _Clock8();
}

class _Clock8 extends State<Clock8> {
//sharedPref.save("med", med);
  ...
  late TimeOfDay selectedTime4 = TimeOfDay.now();

  late TimeOfDay selectedTime5 = TimeOfDay.now();

  late TimeOfDay selectedTime6 = TimeOfDay.now();

  late TimeOfDay selectedTime7 = TimeOfDay.now();

  late TimeOfDay selectedTime8 = TimeOfDay.now();
  ...
  _selectTime(BuildContext context) async {
    ...
    if (timeOfDay != null && timeOfDay != selectedTime) {
      setState(() {
        ...
        selectedTime2 =
            TimeOfDayBuilder(time: selectedTime, amount: amount).timeFix();
        selectedTime3 =
            TimeOfDayBuilder(time: selectedTime2, amount: amount).timeFix();
        selectedTime4 =
            TimeOfDayBuilder(time: selectedTime3, amount: amount).timeFix();
        selectedTime5 =
            TimeOfDayBuilder(time: selectedTime4, amount: amount).timeFix();
        selectedTime6 =
            TimeOfDayBuilder(time: selectedTime5, amount: amount).timeFix();
        selectedTime7 =
            TimeOfDayBuilder(time: selectedTime6, amount: amount).timeFix();
        selectedTime8 =
            TimeOfDayBuilder(time: selectedTime7, amount: amount).timeFix();
      });
    }
  }
